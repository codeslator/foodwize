...
import { PRODUCT_INITIAL_VALUES, PRODUCT_VALIDATION_SCHEMA, IProduct } from '../../utils/validations/suplliersValidations';
...
const ProductForm: FC<ProductFormProps> = ({ isLoading, onSave }) => {
  return (
    <Formik
